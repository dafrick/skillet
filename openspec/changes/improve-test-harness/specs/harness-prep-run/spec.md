...
- **THEN** the repository is cloned to `/repo/repo` inside `skillet-test-container` and the command exits 0
...
- **THEN** it informs them that the repository has already been cloned and gives them the path inside the container (`/repo/<slug>`)
